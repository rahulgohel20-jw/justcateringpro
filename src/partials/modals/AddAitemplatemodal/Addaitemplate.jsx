...
const FloatingInput = ({ label, name, type = "text", placeholder = "" }) => (
  <div className="relative">
    ...
    <Field
      ...
      className="w-full border border-gray-200 rounded-xl px-3 pt-4 pb-2 text-sm text-gray-800 placeholder-gray-300 focus:outline-none focus:ring-2 focus:border-transparent transition"
...
const FloatingTextarea = ({
  ...
  <div className="relative">
    ...
    <Field
      ...
      rows={rows}
      placeholder={placeholder}
      className={`w-full border border-gray-200 rounded-xl px-3 pt-4 pb-2 text-sm resize-none placeholder-gray-300 focus:outline-none focus:ring-2 focus:border-transparent transition ${
        muted ? "bg-gray-50 text-gray-400" : "bg-white text-gray-800"
      }`}
      onFocus={(e) => (e.target.style.boxShadow = "0 0 0 3px #594CEB22")}
      onBlur={(e) => (e.target.style.boxShadow = "")}
    />
...
// ─── Main component ───────────────────────────────────────────────────────────
const Addaitemplate = ({ isOpen, onClose, contactType, refreshData }) => {
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <Field
                          ...
                          className="w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm text-gray-800 placeholder-gray-300 pr-9 focus:outline-none transition"
                          onFocus={(e) =>
