...
const backDateMin = isBackDateLocked ? new Date() : undefined;
  ...
  const eventPrefillRef = prefillAppliedRef || localPrefillRef; 

   useEffect(() => {
    if (eventPrefillRef.current) return;              // ← guard
    ...
    eventPrefillRef.current = true;                    // ← set once, survives remounts
...
/>
          ...
          <AddBanquetModal
            ...
            refreshData={fetchBanquets} // ← refetch banquet list after adding
            userId={Id}
          />
        </div>
      </Form>
