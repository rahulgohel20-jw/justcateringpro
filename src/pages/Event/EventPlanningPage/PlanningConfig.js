...
nicknames: {
  ...
  gujarati: rawItem[fields.itemNicknameGujarati] || "",
    ...
    subItem:        (rawItem.subItem        || "").replace(/&amp;/gi, "&"),
    subItemHindi:   (rawItem.subItemHindi   || "").replace(/&amp;/gi, "&"),
    subItemGujarati:(rawItem.subItemGujarati|| "").replace(/&amp;/gi, "&"),
    itemHeading:          (rawItem.itemHeading          || "").replace(/&amp;/gi, "&"),
    itemHeadingHindi:     (rawItem.itemHeadingHindi     || "").replace(/&amp;/gi, "&"),
    itemHeadingGujarati:  (rawItem.itemHeadingGujarati  || "").replace(/&amp;/gi, "&"),
...
const catName         = originalCatName;
  ...
  const subCat = {
    english:  (rawCat.subCat        || "").replace(/&amp;/gi, "&"),
    hindi:    (rawCat.subCatHindi   || "").replace(/&amp;/gi, "&"),
    gujarati: (rawCat.subCatGujarati|| "").replace(/&amp;/gi, "&"),
  };
  const catHeading = {  
    english:  (rawCat.catHeadingEnglish  || "").replace(/&amp;/gi, "&"),
    hindi:    (rawCat.catHeadingHindi    || "").replace(/&amp;/gi, "&"),
    gujarati: (rawCat.catHeadingGujarati || "").replace(/&amp;/gi, "&"),
  };
...
rate: (() => {
  ...
  return Number(flatPrice);
      ...
      subItem:         (it.subItem         || "").replace(/&amp;/gi, "&"),
      subItemHindi:    (it.subItemHindi    || "").replace(/&amp;/gi, "&"),
      subItemGujarati: (it.subItemGujarati || "").replace(/&amp;/gi, "&"),
      itemHeading:          (it.itemHeading          || "").replace(/&amp;/gi, "&"),
      itemHeadingHindi:     (it.itemHeadingHindi     || "").replace(/&amp;/gi, "&"),
      itemHeadingGujarati:  (it.itemHeadingGujarati  || "").replace(/&amp;/gi, "&"),
...
changedAfterCompletion:   allItems[0]?.changedAfterCompletion ?? null,
      ...
      catSpace,
      subCat:         (subCatData.english  || "").replace(/&amp;/gi, "&"),
      subCatHindi:    (subCatData.hindi    || "").replace(/&amp;/gi, "&"),
      subCatGujarati: (subCatData.gujarati || "").replace(/&amp;/gi, "&"),
      catHeadingEnglish:  (headingData.english  || "").replace(/&amp;/gi, "&"),   
      catHeadingGujarati: (headingData.gujarati || "").replace(/&amp;/gi, "&"),   
      catHeadingHindi:    (headingData.hindi    || "").replace(/&amp;/gi, "&"),
      selectedMenuPreparationItems: items.map((item, itemIndex) => ({
        ...
        itemHeading:          (item.itemHeading         || "").replace(/&amp;/gi, "&"),
...
function buildDecorPayload(state) {
  ...
  return anyItemWithCatId?.catId || 0;
      ...
      selectedItems: items.map((item, itemIndex) => ({
        ...
        itemSpace:               Number(item.itemSpace) || 0,
        subItem:                 (item.subItem         || "").replace(/&amp;/gi, "&"),
        subItemHindi:            (item.subItemHindi    || "").replace(/&amp;/gi, "&"),
        subItemGujarati:         (item.subItemGujarati || "").replace(/&amp;/gi, "&"),
