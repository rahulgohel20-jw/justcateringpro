...
import {
  ...
  AddGenerateAutoManualCrockerySOT,
  GenerateCrockeryManualPO,
  AddLogs
...
const GenerateCrockeryAutoManual = () => {
  ...
  // ── Save: update details first, then always call GenerateCrockeryManualPO ────────────
  ...
  const res1 = await AddGenerateAutoManualCrockerySOT(payload);
 

  try {
    const res2 = await GenerateCrockeryManualPO(poData.id, userId);
    ...
    const errMsg =
      ...
      poError?.message ||
      "Unknown error";
    console.error("GenerateCrockeryManualPO failed:", errMsg);
  ...
  console.error("AddGenerateAutoManualCrockerySOT failed:", e?.response?.data || e?.message || e);
...
export default GenerateCrockeryAutoManual;