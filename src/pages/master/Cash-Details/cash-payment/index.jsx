...
import { cashPaymentColumns } from "./constant";
import {
...
const CashPayment = () => {
  const permissions = usePermission("cashpayment");
  ...
  useEffect(() => {
    if (subTab && !closeDateLoading && cashSubTabs.length > 0) fetchPayments();
    ...
    <Container>
      <div className="">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-2xl font-bold text-gray-900">Cash Payments</h2>
            <p className="text-sm text-black mt-0.5 mb-2">
              Manage and audit cash capital outflows
            </p>
          </div>
          {permissions.add && (
            <button
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
          ...
          <TableComponent
            columns={cashPaymentColumns(handleAction, permissions)}
            data={filteredData}
