...
const MegaMenuInner = () => {
  ...
  const build = (items) => {
    ...
    const linkClass =
      "menu-link text-lg text-gray-700 font-medium menu-link-hover:text-primary menu-item-active:text-gray-900 menu-item-show:text-primary menu-item-here:text-gray-900";
  ...
  const buildArrow = () => {
    return (
      <MenuArrow className="flex lg:hidden text-gray-400">
        <KeenIcon icon="plus" className="menu-item-show:hidden" />
        <KeenIcon icon="minus" className="hidden menu-item-show:inline-flex" />
      </MenuArrow>
    );
  };
  return (
