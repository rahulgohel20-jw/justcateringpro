...
const applyUpgradedModules = (menuItems, upgradedModules, currentUser) => {
  const GATED_MODULES = ["Account", "Stock", "CRM", "AI Menu", "Menu Share Link", "Banquet" , "Captain Recipe" , "Assign Manager", "Food Taste Festival", "Event Flow", "Decor", "Menu Extra Features" , "kyc" , "followup" , "Security Deposit" , "Purchase Approve" , "Guest Signature" , "Exhibition Quotation"];
